                        ...
                        <div class="app-footer__inner">
                            <div class="app-footer-left">
                                <div class="footer-dots">
                                    <div class="dropdown">
                                        <a aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="dot-btn-wrapper" href="architectui-html-pro.html">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu">
                                            ...
                                            <ul class="tabs-animated-shadow tabs-animated nav nav-justified tabs-shadow-bordered p-3"><li class="nav-item">
                                                                                ...
                                                                                <div class="vertical-timeline-element-content bounce-in">
                                                                                    <h4 class="timeline-title">Something not important
                                                                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                                            ...
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img src="images/avatars-9.jpg" alt=""></div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                            ...
                                            <ul class="nav flex-column"><li class="nav-item-divider nav-item">
                                                </li><li class="nav-item-btn text-center nav-item">
                                    ...
                                    <div class="dropdown">
                                        <a class="dot-btn-wrapper" aria-haspopup="true" data-toggle="dropdown" aria-expanded="false" href="architectui-html-pro.html">
                                    ...
                                    <div class="dots-separator"></div>
                                    <div class="dropdown">
                                        <a class="dot-btn-wrapper dd-chart-btn-2" aria-haspopup="true" data-toggle="dropdown" aria-expanded="false" href="architectui-html-pro.html">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu">
                                            ...
                                            <ul class="nav flex-column"><li class="nav-item-divider mt-0 nav-item">
                                                </li>
                                                    ...
                                                    <div class="grid-menu grid-menu-2col">
                                                        <div class="no-gutters row">
                                                            <div class="col-sm-6 col-xl-6">
                                                                <ul class="nav flex-column"><li class="nav-item-header nav-item">Overview</li>
                                                                    <li class="nav-item"><a class="nav-link" href="architectui-html-pro.html"><i class="nav-link-icon lnr-inbox"> </i><span>Contacts</span></a></li>
                                                                    <li class="nav-item"><a class="nav-link" href="architectui-html-pro.html"><i class="nav-link-icon lnr-book"> </i><span>Incidents</span>
                                                                        <div class="ml-auto badge badge-pill badge-danger">5</div>
                                                                    </a></li>
                                                                    <li class="nav-item"><a class="nav-link" href="architectui-html-pro.html"><i class="nav-link-icon lnr-picture"> </i><span>Companies</span></a></li>
                                                                    <li class="nav-item"><a disabled class="nav-link disabled" href="architectui-html-pro.html"><i class="nav-link-icon lnr-file-empty"> </i><span>Dashboards</span></a></li>
                                                                </ul></div>
                                                            <div class="col-sm-6 col-xl-6">
                                                                <ul class="nav flex-column"><li class="nav-item-header nav-item">Sales &amp; Marketing</li>
                                                                    <li class="nav-item"><a class="nav-link" href="architectui-html-pro.html">Queues</a></li>
                                                                    <li class="nav-item"><a class="nav-link" href="architectui-html-pro.html">Resource Groups</a></li>
                                                                    <li class="nav-item"><a class="nav-link" href="architectui-html-pro.html">Goal Metrics
                                                                        <div class="ml-auto badge badge-warning">3</div>
                                                                    </a></li>
                                                                    <li class="nav-item"><a class="nav-link" href="architectui-html-pro.html">Campaigns</a></li>
                                                                </ul></div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="rm-max-width rm-pointers">
                                            <div class="d-none popover-custom-content">
                                                ...
                                                <ul class="nav flex-column"><li class="nav-item-divider nav-item">
                                                    </li><li class="nav-item-btn clearfix nav-item">
