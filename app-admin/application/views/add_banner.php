                ...
                <div class="app-main__inner">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form id="signupForm" class="col-md-10 mx-auto" method="post" action="<?php echo base_url('banner/insert_banner');?>" enctype="multipart/form-data">
                                
        
                                <div class="form-group">
                                    <label for="lang_id">Lang Id</label>
                                    <div>
                                        <input type="Number" class="form-control" id="lang_id" name="lang_id" placeholder="Please Enter Your Lang Id"></div>
                                </div>
                              
                                <div class="form-group">
                                    <label for="cat_name">Category Name </label>
                                    <div>
                                        <input type="text" class="form-control" id="cat_name" name="cat_name" placeholder="Please Enter Category Name"></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <select name="banner_type" id="banner_type" class="form-control">
                                        ...
                                        <option value="0">Home Slider</option>
                                        <option value="1">Top Offers</option>
                                        <option value="2">Bottom Offers</option>
                                    </select>
                                </div>
                                <div class="form-group">
