...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Sub Category View</title>
                ...
                <div class="app-main__inner">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col-12 col-md-3 p-0 mb-3">
                            <a href="<?php echo base_url('sub_category/add_sub_category');?>"><button type="button" class="btn-shadow dropdown-toggle btn btn-danger">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                        ...
                                        <td><img src="<?php echo base_url(); ?><?php echo $row['sub_cat_banner_image']?>" data-toggle="tooltip" data-placement="top" title="Avatar Name" height="80" width="80" alt="Avatar" class="w35 h35 rounded"></td>
                                        ...
                                        <td>
                                        <?php if ($row['status'] == '1') { ?>
                                        <a  Onclick="return Inactive();" href="<?php echo base_url(); ?>sub_category/sub_category_status/<?php echo $row['sub_cat_id'].'/0'?>" data-toggle="tooltip" title="Inactive" class="btn btn-sm btn-danger changestatus"><span  class="pe-7s-door-lock" title="Inactive"></span></a>
                                        <?php } else { ?>
                                        <a  Onclick="return Active();" href="<?php echo base_url(); ?>sub_category/sub_category_status/<?php echo $row['sub_cat_id'].'/1'?>" data-toggle="tooltip" title="Active" class="btn btn-sm btn-success changestatus"><span class="pe-7s-door-lock" title="Active"></span></a>
                                        <?php } ?>
                                        

                                        <a href="<?php echo base_url(); ?>sub_category/edit_sub_category/<?php echo $row['sub_cat_id'];?>"><button type="button" class="btn btn-gradient-warning btn-sm " data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="pe-7s-trash pe-7s-link"></i></button></a>
                                        
                                        <a Onclick="return ConfirmDelete();" href="<?php echo base_url(); ?>sub_category/delete_sub_category/<?php echo $row['sub_cat_id'];?>"><button type="button" class="btn btn-info btn-sm removebtn" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="pe-7s-trash btn-icon-wrapper"></i></button></a>
