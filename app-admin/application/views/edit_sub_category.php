            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                           <?php foreach ($view_edit_sub_category as $row) {?>
                            <form id="signupForm" class="col-md-10 mx-auto" method="post" action="<?php echo base_url('sub_category/update_sub_category');?>" enctype="multipart/form-data">
                                
                                <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['sub_cat_id'];?>" placeholder="Please Enter Your Land Id">  
                               
                                <div class="form-group">
                                    <label for="lang_id">Lang ID</label>
                                    <div>
                                        <input type="number" class="form-control" id="lang_id" name="lang_id" value="<?php echo $row['lang_id'];?>" placeholder="Please Enter Your Land Id"></div>
                                </div>
                                <div class="form-group">
                                    <label for="lang_id">Category Type</label>
                                    <div>
                                        <input type="number" class="form-control" id="cat_id" name="cat_id" value="<?php echo $row['cat_id'];?>" readonly placeholder="Please Enter Your Land Id"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="sub_cat_name" name="sub_cat_name" value="<?php echo $row['sub_cat_name'];?>" placeholder="Please Enter Your Sub Category Name"></div>
                                </div>
                                <div class="form-group">
                                    <label for="sub_cat_desc">Sub Category Description </label>
                                    <div>
                                       
                                        <textarea rows="1" class="form-control autosize-input" id="sub_cat_desc" name="sub_cat_desc" style="max-height: 200px; height: 35px;"><?php echo $row['sub_cat_desc'];?></textarea>
                                    </div>
                                </div>  
                                <div class="form-group">
                                <label for="sub_cat_image"> Sub Category Image </label>
                                <div>
                                <img src="<?php echo base_url(); ?><?php echo $row['sub_cat_image']?>" data-toggle="tooltip" data-placement="top" title="Avatar Name" height="100" width="100" alt="Avatar" class="w35 h35 rounded">
                                ...
                                <div>
                                <img src="<?php echo base_url(); ?><?php echo $row['sub_cat_banner_image']?>" data-toggle="tooltip" data-placement="top" title="Avatar Name" height="100" width="100" alt="Avatar" class="w35 h35 rounded">
