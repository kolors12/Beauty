                ...
                <div class="app-main__inner">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col-12 col-md-3 p-0 mb-3">
                            <a href="<?php echo base_url('vendors/vendors_view');?>"><button type="button" class="btn-shadow dropdown-toggle btn btn-info">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
						    ...
						    <div class="row">
								...
								<div class="row">
								<?php  foreach ($vendors_details as $row) {?>
								<div class="col-md-5">
