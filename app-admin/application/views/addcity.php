                ...
                <div class="app-main__inner">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form id="signupForm" class="col-md-10 mx-auto" method="post" action="<?php echo base_url('cities/insert_city')?>" >
                                <div class="form-group">
                                    <label for="cityname">City Name</label>
                                    <div>
                                        <input type="text" class="form-control" id="cityname" name="cityname" placeholder="City Name" required>
                                    </div>
                                </div>
