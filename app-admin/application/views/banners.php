...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Banners View</title>
                ...
                <div class="app-main__inner">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col-12 col-md-3 p-0 mb-3">
                            <a href="<?php echo base_url('banner/add_banner');?>"><button type="button" class="btn-shadow dropdown-toggle btn btn-secondary">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                        ...
                                        <td> <?php if($row['banner_type'] == "0"){ ?>
                                       <button class="btn btn-pill btn-primary">Home Slider</button>
                                        <?php }elseif  ($row['banner_type'] == "1") { ?>
                                        <button class="btn btn-pill btn-info">Top Offers</button>
                                        <?php } else { ?>
                                        <button class="btn btn-pill btn-success">Bottom Offers	</button>
                                        <?php }?>
                                        </td>
                                        ...
                                        <td>
                                        <?php if ($row['status'] == '1') { ?>
                                        <a  Onclick="return Inactive();" href="<?php echo base_url(); ?>banner/banner_status/<?php echo $row['cat_id'].'/0'?>" data-toggle="tooltip" title="Inactive" class="btn btn-sm btn-danger changestatus"><span  class="pe-7s-door-lock" title="Inactive"></span></a>
                                        <?php } else { ?>
                                        <a  Onclick="return Active();" href="<?php echo base_url(); ?>banner/banner_status/<?php echo $row['cat_id'].'/1'?>" data-toggle="tooltip" title="Active" class="btn btn-sm btn-success changestatus"><span class="pe-7s-door-lock" title="Active"></span></a>
                                        <?php } ?>
                                        

                                        <a href="<?php echo base_url(); ?>banner/edit_banner/<?php echo $row['cat_id'];?>"><button type="button" class="btn btn-gradient-warning btn-sm " data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="pe-7s-trash pe-7s-link"></i></button></a>
                                        
                                        <a Onclick="return ConfirmDelete();" href="<?php echo base_url(); ?>banner/delete_banner/<?php echo $row['cat_id'];?>"><button type="button" class="btn btn-info btn-sm removebtn" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="pe-7s-trash btn-icon-wrapper"></i></button></a>
