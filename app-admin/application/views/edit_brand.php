...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Edit Brand</title>
                ...
                <div class="app-main__inner">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <div class="col-12 col-md-3 p-0 mb-3">
                            <a href="<?php echo base_url('brands/brands_view');?>"><button type="button" class="btn-shadow dropdown-toggle btn btn-warning">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                        <?php foreach ($view_edit_brand as $row) {?>
                            <form id="signupForm" class="col-md-10 mx-auto" method="post" action="<?php echo base_url('brands/update_brand');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $row['name']?>" placeholder="Please Enter Brand Name "></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <button type="submit" class="ladda-button mb-2 mr-2 btn btn-warning" name="signup" value="Sign up">Update</button>
                                </div>
                            </form>
                            <?php }?>
                        </div>
