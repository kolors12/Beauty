                ...
                <div class="app-main__inner">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form id="signupForm" class="col-md-10 mx-auto" method="post" action="<?php echo base_url('brands/insert_brand');?>" enctype="multipart/form-data">
                                
                                
                                <div class="form-group">
                                    <label for="name">Brand Name</label>
                                    <div>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Please Enter Brand Name "></div>
                                </div>
                                <div class="form-group">
