...
<body style="background: #E3E5E7;">
  <div style="background-color:#E3E5E7;"><!--[if mso | IE]>
      ...
      <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" border="0"><tbody>
		  <tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;" align="center" border="0">
			  <tbody><tr>
				  <td style="width:80px;">
				  <a href="about:blank" target="_blank">
				  <img src="<?php echo base_url();?>assets/front_end/images/stick_logo.png" alt="Big Beauty Pack" width="220" height="70" style="display: block;" /></a>
				 </td>
						</tr>
					</tbody>
				</table>
	  ...
	  <tr>
	  <td style="width:80px;">
	  <img alt="Zero To Launch" title="" height="auto" src="https://cdn.auth0.com/website/emails/product/top-verify.png" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:auto;" width="80">
	  </td>
	  </tr>
	  </tbody>
	  </table>
	  ...
	  <div style="cursor:auto;color:white;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30ps;">
	  ...
	  <tr>
	  <td style="word-break:break-word;font-size:0px;padding:0px 20px 0px 20px;" align="center">
	  <div style="cursor:auto;color:black;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30ps;">
              Thank you for registering with us, we are delighted to welcome you to Hocomoco family! 
			    <p>You may reach out to us at info@hocomoco.in or call us at 9121172233.</p>			  
	  </div>
	  </td>
	  </tr>
	  </tbody>
	  ...
	  <div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:18px;font-weight:500;line-height:30px;" align="center">
	  ...
	  <div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30px;" align="center">
      <strong style="font-weight: 500; white-space: nowrap;">Name</strong>
      </div>
	  </td>
	  </tr>
	  </tbody>
	  ...
	  <td style="word-break:break-word;font-size:0px;padding:0px 0px 25px;" align="left">
	  <div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30px;" align="center">
      <a href="#" style="color:#0a84ae; text-decoration:none" target="_blank"><?php echo $email_id ?></a>
      </div>
	  </td>
	  </tr>
	  </tbody>
	  ...
	  <td style="word-break:break-word;font-size:0px;padding:0px 0px 10px;" align="left">
	  <div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30px;" align="center">
      <strong style="font-weight: 500; white-space: nowrap;">Phone</strong>
      </div>
	  </td>
	  </tr>
	  </tbody>
	  ...
	  <td style="word-break:break-word;font-size:0px;padding:0px 0px 25px;" align="left">
	  <div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:16px;line-height:30px;" align="center">
      <a href="#" style="color:#0a84ae; text-decoration:none" target="_blank"><?php echo $mobile ?></a>
      </div>
	  </td>
	  </tr>
	  </tbody>
	  ...
	  <div style="margin:0 auto;max-width:600px;background:white;"><table cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:white;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;font-size:0px;padding:0px 30px;"><!--[if mso | IE]>
      ...
      <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:0px 20px;" align="center"><div style="cursor:auto;color:#222228;font-family:'Avenir Next', Avenir, sans-serif;font-size:13px;line-height:20px;">
            You are receiving this email because you have an account in Hocomoco.
            If you are not sure why you are receiving this, please contact us.
